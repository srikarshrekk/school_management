            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form method="post"
                                action="{{route('student.fee_amount.update',$editData['0']->student_fee_id)}}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="add_item">
                                                ...
                                                <div class="controls">
                                                    <select name="student_fee_id" id="student_fee_id" required=""
                                                        ...
                                                        <option value="{{$fee_category->id}}"
                                                            {{($editData['0']->student_fee_id==$fee_category->id) ? "selected":""}}>
                                                            ...
                                                            <div class="controls">
                                                                <select name="student_class_id[]" required=""
                                                                    ...
                                                                    <option value="{{$class->id}}"
                                                                        {{($edit->student_class_id==$class->id)?"selected":""}}>
                                                                        {{$class->name}}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
