        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h4 class="box-title"> {{$editData['0']->StudentClass->name}} Subject Details </h4>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                            <form method="post"
                                action="{{route('student.subject_assign.update',$editData['0']->student_class_id)}}">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="add_item">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="student_class_id" id="student_class_id" required=""
                                                        class="form-control" aria-invalid="false" disabled="">
                                                        <option value="" selected="" disabled="">Select Class
                                                        </option>
                                                        @foreach($classes as $class)
                                                        <option value="{{$class->id}}"
                                                            {{($editData['0']->student_class_id==$class->id) ? "selected":""}}>
                                                            {{$class->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <select name="subject_types_id[]" required=""
                                                                    ...
                                                                    <option value="{{$class->id}}"
                                                                        {{($edit->subject_types_id==$subject_type->id)?"selected":""}}>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="full_mark[]"
                                                                    class="form-control" value="{{$edit->full_mark}}"
                                                                    required="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="pass_mark[]"
                                                                    class="form-control" value="{{$edit->pass_mark}}"
                                                                    required="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="text" name="subjective_mark[]"
                                                                    class="form-control"
                                                                    value="{{$edit->subjective_mark}}" required="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div style="padding-left:20px" class="text-xs-right">
