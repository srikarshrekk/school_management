                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route('student.year.edit',$user->id)}}" class="btn btn-rounded btn-warning mb-5">Edit</a>
                                                <a href="{{route('student.year.delete',$user->id)}}" id="delete" class="btn btn-rounded btn-danger mb-5">Delete</a>
                                            </td>
