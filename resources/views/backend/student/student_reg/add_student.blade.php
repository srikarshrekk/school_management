                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="f_name" id="name" class="form-control"
                                                            required="">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="m_name" id="name" class="form-control"
                                                            required="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="group_id" required="" class="form-control"
                                                            aria-invalid="false">
                                                            <option value="" selected="" disables="">Select Group
                                                            </option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <img id="showimage"
                                                            src="{{(!empty($user->profile_photo_path))? url('upload/student_images/'.$user->profile_photo_path):url('upload/no_image.jpg')}}"
